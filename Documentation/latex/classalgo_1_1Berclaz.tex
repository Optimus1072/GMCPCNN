...
\subsubsection[{\texorpdfstring{Berclaz(int h\+\_\+res, int v\+\_\+res, int vicinity\+\_\+size)}{Berclaz(int h_res, int v_res, int vicinity_size)}}]{\setlength{\rightskip}{0pt plus 5cm}algo\+::\+Berclaz\+::\+Berclaz (
